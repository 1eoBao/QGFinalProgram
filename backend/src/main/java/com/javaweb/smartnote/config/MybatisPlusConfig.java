    ...
    public MetaObjectHandler metaObjectHandler() {
        return new MetaObjectHandler() {
            ...
            public void insertFill(MetaObject metaObject) {
                ...
                this.strictInsertFill(metaObject, "lastEditTime", LocalDateTime.class, LocalDateTime.now());
                ...
                this.strictInsertFill(metaObject, "analysisTime", LocalDateTime.class, LocalDateTime.now());
            }
